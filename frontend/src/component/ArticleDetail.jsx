        ...
        <div className="modal-content rounded-4 border-0 shadow-lg overflow-hidden">
          ...
          >
            <div className="d-flex align-items-center">
              ...
              >
                <i className="bi bi-newspaper fs-4 text-white"></i>
              </div>
              <div>
                <h5 className="modal-title mb-1 fw-bold">Chi Tiết Bài Viết</h5>
                <small className="text-white-75">Mã: {article.maBV || "N/A"}</small>
              </div>
            </div>
            {showClose && (
              <button
                  ...
                  <div className="card-body p-0">
                    ...
                    <div className="p-3">
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        <span
                          className={`badge px-3 py-2 rounded-pill fw-semibold ${article.trangThaiBV ? "bg-success" : "bg-danger"}`}
                        >
                          {article.trangThaiBV ? "Hoạt động" : "Ngừng"}
                        </span>
                      </div>
                      <div className="row g-2">
                        <div className="col-6">
                          <small className="text-muted d-block">Loại</small>
                          <p className="mb-0 fw-semibold">{article.maLoaiBV || "N/A"}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-lg-7">
                ...
                >
                  <div className="card-body p-4">
                    <h4 className="card-title mb-3 fw-bold text-primary">{article.tenBV || "Không có tên"}</h4>

                    <p className="card-text">{article.tomTatBV || "Không có tóm tắt"}</p>


                    {article.tomTatBV && (
                      <div className="mb-3">
                        <h6 className="text-primary mb-2">
                          <i className="bi bi-info-circle me-2"></i>Tóm Tắt Bài Viết
                        </h6>
                        <p className="text-secondary mb-0">{article.tomTatBV}</p>
                      </div>
                    )}
                    ...
                    {article.noiDungBV && (
                      <div>
                        <h6 className="text-primary mb-2">
                          <i className="bi bi-file-text me-2"></i>Nội Dung Bài Viết
                        </h6>
                        <div
          ...
          >
            <small className="text-muted">
              <i className="bi bi-hash me-1"></i>Bài viết ID: {article.maBV || "-"}
            </small>
            <button
              type="button"
