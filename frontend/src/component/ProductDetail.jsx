        ...
        <div className="modal-content rounded-4 border-0 shadow-lg overflow-hidden">
          ...
          >
            <div className="d-flex align-items-center">
              ...
              <div>
                <h5 className="modal-title mb-1 fw-bold">Chi Tiết Sản Phẩm</h5>
                <small className="text-white-75">Mã: {product.maSanPham || "N/A"}</small>
              </div>
            </div>
            {showClose && (
              <button
                  ...
                  <div className="card-body p-0">
                    {product.hangHoaImages ? (
                      <div className="position-relative">
                        <img
                          src={`http://localhost:5226/public/imagesProduct/${product.hangHoaImages}`}
                    ...
                    <div className="p-3">
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        ...
                        >
                          <i className="bi bi-box me-1"></i>SL: {product.soLuong ?? 0}
                        </span>
                        <span
                          className={`badge px-3 py-2 rounded-pill fw-semibold ${product.trangThaiSanPham ? "bg-success" : "bg-danger"}`}
                        >
                          {product.trangThaiSanPham ? "Hoạt động" : "Ngừng"}
                        </span>
                      </div>
                      <div className="row g-2">
                        <div className="col-6">
                          <small className="text-muted d-block">Loại</small>
                          <p className="mb-0 fw-semibold">{product.maLoai || "N/A"}</p>
                        </div>
                        <div className="col-6">
                          <small className="text-muted d-block">Brand</small>
                          <p className="mb-0 fw-semibold">{product.maBrand || "N/A"}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-lg-7">
                ...
                >
                  <div className="card-body p-4">
                    <h4 className="card-title mb-3 fw-bold text-primary">{product.tenSanPham || "Không có tên"}</h4>
                    <div className="mb-4">
                      <span className="fs-3 text-success fw-bold">{formatMoney(product.donGia)}</span>
                      ...
                      <div className="col-md-6">
                        <div className="p-3 bg-light rounded-3 h-100">
                          <div className="d-flex align-items-center mb-2">
                            ...
                            <small className="text-muted fw-semibold">Ngày nhập</small>
                          </div>
                          <p className="mb-0 fw-medium">{product.ngayNhap || "Chưa cập nhật"}</p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="p-3 bg-light rounded-3 h-100">
                          <div className="d-flex align-items-center mb-2">
                            ...
                            <small className="text-muted fw-semibold">Bảo hành</small>
                          </div>
                          <p className="mb-0 fw-medium">{product.hanBaoHanh ?? 0} tháng</p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="p-3 bg-light rounded-3 h-100">
                          <div className="d-flex align-items-center mb-2">
                            ...
                            <small className="text-muted fw-semibold">Tình trạng</small>
                          </div>
                          <p className="mb-0 fw-medium">{product.tinhTrangSanPham ? "Mới" : "Cũ"}</p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="p-3 bg-light rounded-3 h-100">
                          <div className="d-flex align-items-center mb-2">
                            <i className="bi bi-warehouse text-warning me-2"></i>
                            <small className="text-muted fw-semibold">Tồn kho</small>
                          </div>
                          <p className="mb-0 fw-medium">{product.soLuong ?? 0} sản phẩm</p>
                        </div>
                      </div>
                    </div>
                    ...
                    {product.shortDescription && (
                      <div className="mb-3">
                        <h6 className="text-primary mb-2">
                          <i className="bi bi-info-circle me-2"></i>Mô tả ngắn
                        </h6>
                        <p className="text-secondary mb-0">{product.shortDescription}</p>
                      </div>
                    )}
                    ...
                    {product.description && (
                      <div>
                        <h6 className="text-primary mb-2">
                          <i className="bi bi-file-text me-2"></i>Mô tả chi tiết
                        </h6>
                        <div
          ...
          >
            <small className="text-muted">
              <i className="bi bi-hash me-1"></i>Sản phẩm ID: {product.maSanPham || "-"}
            </small>
            <button
              type="button"
